 ...
 * @author lo23a016
 */
public class SetProfilePopUp extends JFrame {

    private View _parent;
    // Management
    private boolean _newProfile;
    // Panels
    private JPanel _mainPan;
     ...
     */
    SetProfilePopUp(View parent)
    {
        this._parent = parent;
        this.setSize(LobbyConstant.SET_PROFILE_VIEW_SIZE_W, LobbyConstant.SET_PROFILE_VIEW_SIZE_H);
    ...
    private void createComboBoxAvatar()
    {
        ...
        /*
        File file = new File(this.getPath() + LobbyConstant.PATH_PICTURE_AVATAR);
        if (file == null)
        {
            System.out.print("Erreur : " + this.getPath() + LobbyConstant.PATH_PICTURE_AVATAR + " non trouvé");
        }
    ...
    private void setCompProperties()
    {
        ...
        Object lastview = this._parent.getParentFrame().getLastView();
        Profile player = this._parent.getParentFrame().getUserProfile();
    ...
    private int getIndexOfPicture(String pic)
    {
         for (int i = 0; i < LobbyConstant.LIST_AVATAR.length; i++)
            {
                    String str = LobbyConstant.LIST_AVATAR[i];
                    if (str.compareToIgnoreCase(pic + ".png") == 0 && LobbyConstant.isAutorized(str))
                    {
                        return i;
                    }
    ...
    */
    ...
    private void saveProfile()
    {
        ...
        if (this._newProfile)
        {
            ...
            this._parent.getParentFrame().setUserProfile(player);
        ...
        {
            player = this._parent.getParentFrame().getUserProfile();
...
/*
        ...
        if (this._newProfile)
        {
            ...
            try
            {
                Profile test = this._parent.getParentFrame().getUserProfile();
                netInterface = new NetworkImplementation(test);
                netInterface.startThreadListenNetwork();
                this._parent.getParentFrame().setNetInterface(netInterface);;
            ...
            // load main view
            this._parent.getParentFrame().loadView(new MainView(this._parent.getParentFrame()));
        }
        else
        {
 * */
            ...
            try
            {
                this._parent.getParentFrame().getNetInterface().sendProfileUpdate(this._parent.getParentFrame().getUserProfile());
            ...
            MainView tmp = (MainView)this._parent;
           tmp.getProfilePlayerPan().updateComponents();
            this._parent.popup = null;
            dispose();
        //}
    }
    ...
    private void addComp()
    {
        ...
        this._mainPan.add(this._leftPan);
        this._mainPan.add(this._rightPan);
    ...
    {
        private SetProfilePopUp parent;

        actionComboBoxAvatar(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class buttonSave implements ActionListener
    {
        ...
        buttonSave(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class buttonCancel implements ActionListener
    {
        ...
        buttonCancel(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class focusPassword implements FocusListener
    {
        ...
        focusPassword(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class focusPasswordBis implements FocusListener
    {
        ...
        focusPasswordBis(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class focusName implements FocusListener
    {
        ...
        focusName(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class focusPrenom implements FocusListener
    {
        ...
        focusPrenom(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class focusAge implements FocusListener
    {
        ...
        focusAge(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
    ...
    private class focusPseudo implements FocusListener
    {
        ...
        focusPseudo(SetProfilePopUp parent)
        {
            this.parent = parent;
        }
